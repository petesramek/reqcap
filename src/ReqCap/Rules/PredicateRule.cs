...
public sealed class PredicateRule<TCapability> : IRule<TCapability>
    ...
    public PredicateRule(string name, Func<TCapability, bool> predicate, RequirementSeverity severity, string? alias = null, string? message = null) {
    ...
    public EvaluationResult Evaluate(TCapability capability) {
        ...
        var issue = new Issue { Property = string.Empty, Message = _message ?? $"Rule '{_name}' failed.", Severity = _severity, RuleName = _name, RuleAlias = _alias };
