...
{
    /// <summary>
    /// Gets a value indicating whether evaluation passed without blocking errors.
    /// </summary>
    public bool Allowed { get; init; }

    /// <summary>
    /// Gets blocking errors produced during evaluation.
    /// </summary>
    public IReadOnlyList<Issue> Errors { get; init; } = [];

    /// <summary>
    /// Gets non-blocking warnings produced during evaluation.
    /// </summary>
    ...
    /// <summary>
    /// Creates an evaluation result from a single issue.
    /// </summary>
